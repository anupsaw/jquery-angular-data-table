...
(function () {
  ...
  SearchService = (function (_super) {
    ...
    function SearchService(config, logger, data_objects, app, errors) {
      ...
      this.logger = __bind(this.logger, this);  // Jaya
    ...
    SearchService.prototype.get_datatable = function (req, res) {
      ...
      logger(JSON.stringify(req.body)); // jaya logger -temp code
      if (req.body != null) {
        body = req.body;
        draw = body.draw;
    ...
    // Jaya
    SearchService.prototype.getPaginatedItems = function (items, startRecord, perPageRecords) {
    ...
    // Jaya
    SearchService.prototype.logger = function (data) {
